...
var Hive = (function () {
    function Hive(name, address, beesAmount, installationDate, lastHarvestDate, description, comment) {
        this._id = utils_1.Guid.genId();
        this._name = name;
        this._address = address == undefined ? "" : address;
        this._beesAmount = beesAmount == undefined ? 0 : beesAmount;
        this._installationDate = installationDate == undefined ? new Date() : installationDate;
        this._lastHarvestDate = lastHarvestDate == undefined ? new Date() : lastHarvestDate;
